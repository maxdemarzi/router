 ...
 * Taken from: https://stackoverflow.com/questions/4209760/validate-an-ip-address-with-mask
 */
public class Subnet
{
    ...
    public Subnet( final String address) throws UnknownHostException {
        String[] split = address.split("/");
        InetAddress subnetAddress = InetAddress.getByName(split[0]);
